...
public class AutoCompleteCountryAdapter extends ArrayAdapter<CountryItem> {
    ...
    public AutoCompleteCountryAdapter(@NonNull Context context, @NonNull List<CountryItem> countryItemsList) {
        super(context, 0, countryItemsList);
        countryListFull = new ArrayList<>(countryItemsList);
    }
